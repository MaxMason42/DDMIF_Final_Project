...
def main(
    ...
    features = pd.concat(
        [
            deep_momentum_strategy_features(pull_wrds_sample_data(ticker)).assign(
                ticker=ticker
            )
...
if __name__ == "__main__":
    ...
    def get_args():
        ...
        return (
            WRDS_TICKERS,
            CPD_WRDS_OUTPUT_FOLDER(args.lookback_window_length),
            args.lookback_window_length,
            FEATURES_WRDS_FILE_PATH(args.lookback_window_length),
            args.extra_lbw,
        )
